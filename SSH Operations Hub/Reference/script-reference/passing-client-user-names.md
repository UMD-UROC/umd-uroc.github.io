...
This flag works the same way that the `-user` flag works, except it defines the secondary client's username.

```bash
# Example Usage

# Make default pool's users root and secondary pool's users admin
